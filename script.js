...
const levels = [
  ...
  { title: 'Уровень 4', file: 'back.svg', size: 11, start: [8, 3], finish: [3, 7], path: [[8,3],[7,3],[6,3],[6,4],[5,4],[4,4],[4,5],[4,6],[3,6],[3,7]], hint: 'Поднимись по увеличенной лесенке к финишу ближе к центру.' },
