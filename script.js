...
const levels = [
  ...
  { title: 'Уровень 4', file: 'back.svg', size: 10, start: [7, 0], finish: [5, 8], path: [[7,0],[6,0],[6,1],[5,1],[4,1],[4,2],[3,2],[3,3],[3,4],[3,5],[3,6],[4,6],[5,6],[5,7],[5,8]], hint: 'Поднимайся змейкой по арке к финишу.' },
